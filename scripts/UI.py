...
from scripts.load_music import load_song_to_dict  # assumes this function exists and works
import cv2
...
@app.route('/')
def index():
    current_emotion = shared_data.get('emotion', 'neutral') if shared_data else 'neutral'
